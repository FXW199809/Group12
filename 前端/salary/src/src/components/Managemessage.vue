...
<div id="Managemessage">
    ...
    <div class="table-center">
      ...
      style="width: 100%">
            ...
            <el-table-column prop="JiGuan" label="籍贯" width="140"> </el-table-column>
            <el-table-column prop="MinZu" label="民族" width="140"> </el-table-column>
            <el-table-column prop="XueWei" label="最高学位" width="140"> </el-table-column>
...
<!-- 新增 -->
    ...
    <el-form-item label="籍贯">
      <el-input v-model="editsForm.JiGuan" disabled="disabled"></el-input>
    </el-form-item>
    <el-form-item label="民族">
      <el-input v-model="editsForm.MinZu" disabled="disabled"></el-input>
    </el-form-item>
    <el-form-item label="最高学位">
      <el-radio-group v-model="editsForm.XueWei">
     ...
     deleteRow:function(){
      ...
      closeDialog(){
        this.editUserForm = false;
          ...
          // 点击编辑信息弹框的确定按钮
          updateUser() {
            checkMobile(this.editUserForm.telephone)
            ...
            nation:this.form.country,
            origin:this.form.JiGuan
        })
        this.$axios({
            method: 'post',
            url:'/updateUser',
